...
let tvGuide = {
    ...
    update: function(callback) {
        ...
        getGzipped(TV_GUIDE_URL, function(xml) {
            ...
            getGzipped(TV_GUIDE_URL_OLD, function(xmlOld) {
                ...
                tvGuide._updateFromXMTLTV_JSON(jsonOld);
                log("Updated");
    ...
    _updateFromXMTLTV_JSON(json) {
        //update channels and programs from json generated by xml2json from xmltv file
